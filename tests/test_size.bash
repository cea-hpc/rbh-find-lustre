...
test_equal_1M()
{
    ...
    rbh_lfind "rbh:mongo:$testdb" -size 1M | sort |
        difflines "/" "/1M"
}
...
test_plus_3M()
{
    ...
    rbh_lfind "rbh:mongo:$testdb" -size +3M | sort |
        difflines "/3M+1" "/4M"
}
...
test_plus_1M_minus_2G()
{
    ...
    rbh_lfind "rbh:mongo:$testdb" -size +1M -size -2G | sort |
        difflines "/1.xM" "/4M"
}
...
test_branch_equal_1M()
{
    ...
    rbh_lfind "rbh:mongo:$testdb#dir" -size 1M | sort |
...
test_branch_plus_3M()
{
    ...
    rbh_lfind "rbh:mongo:$testdb#dir" -size +3M | sort |
...
test_branch_plus_1M_minus_2G()
{
    ...
    rbh_lfind "rbh:mongo:$testdb#dir" -size +1M -size -2G | sort |
