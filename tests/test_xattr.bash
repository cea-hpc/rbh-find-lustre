...
test_xattr_exists_no_arg()
{
    ...
    ! rbh_lfind "rbh:mongo:$testdb" -xattr
}
...
test_not_xattr_exists()
{
    ...
    rbh_lfind "rbh:mongo:$testdb" -not -xattr user | sort |
        difflines "/"
    rbh_lfind "rbh:mongo:$testdb" -not -xattr user.key | sort |
        difflines "/"
    rbh_lfind "rbh:mongo:$testdb" -not -xattr user.err | sort |
        difflines "/" "/file"
    rbh_lfind "rbh:mongo:$testdb" -not -xattr err | sort |
        difflines "/" "/file"
}
